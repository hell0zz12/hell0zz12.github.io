...
b_2.main = {
    label = tabs.fake:label(calculateGradient({127, 255, 212, 255}, {148, 127, 255, 255}, {255, 127, 170, 255}, {255, 76, 136, 255}, "Hexagon", 2.5) .. "\r ~ Renewed"),
...
b_2.home = {
    discord = tabs.other:button("Our \vDiscord", function ()
        panorama.loadstring(panorama.open("CSGOHud").SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/pKTU2cgP"))
    end),
...
logger.run = function (self)
	b_2.settings.logs.enable:set_callback(function (this)
		...
		callbacks["Hexagon::enemy_shot"](this.value, self.events.evade)
...
local function indicators()
    ...
    if b_2.settings.center:get() and b_2.settings.indicators:get() then
        renderer.text(position.x + scoped, position.y + space, r,g,b,a, "cb", 0, "Hexagon")
...
chat_spammer.phrases = {
    kill = {
        {"YOU'RE TRASH, DON'T EVEN TRY"},
        {"GET GOOD, NOOB"},
        {"CAN'T AFFORD A CONFIG? CRYING?"},
        {"DESTROYED YOU LIKE SPACEX DESTROYS ROCKETS"},
        {"PLAYING WITHOUT HEXAGON IN 2024?"},
        {"EVEN SM_METAN WON'T HELP YOU LOL"},
        {"WHILE YOU SUCK, WE CHILL ON GENESISLEAGUE"},
        {"STOP CRYING AND GET GOOD", "JOIN MY DISCORD - https://discord.gg/pKTU2cgP"},
        {"OUTPLAYED BY A 12 YEAR OLD"},
        {"YOU SHOULD ONLY PLAY AGAINST XOXAIN"},
        {"YOU LICKED MY DIRTY BALLS, SON OF A BITCH"},
        {"SON OF A WHORE, YOU THOUGHT YOU COULD COMPARE?"},
        {"LOL GO BUY PINK VISUALS, FEMBOY", "https://discord.gg/pKTU2cgP"},
        {"DON'T EVEN OPEN YOUR MOUTH", "LOSER", "BETTER BUY MY LUA https://discord.gg/pKTU2cgP"},
        {"LOL EVEN PZ OUTPLAYS YOU", "GO BUY HEXAGON"},
        {"YOU'RE LIKE TANARU, A FUNNY CLOWN++("},
        {"NOW SHAHA WILL SNIFF AND YOU'RE DONE"},
        {"LOL CRINGE", "MY CREW FROM BLÃSSĒD WILL COME"},
        {"KILLED?", "MEANS OUTPLAYED"},
        {"MY HEXAGON DESTROYED YOU, FOOL"},
        {"SAYING CHEAT MISSES, GO BUY SM_METAN #hexagon"},
        {"GOT PREDICTED, LOSER?", "GO BUY POWROTIC'S GRIMOIRES"},
        {"SUCK DICK, CRYING BITCH", "MY HEXAGON BEAT YOU UP"},
        {"EASY MAPS, ALL CARDS EZ", "I'LL TAP YOU LIKE HAMSTERCOIN", "LOL DIED, BUY HEXAGON"},
        {"YOUR MOTHER WAS A WHORE"},
    },

    death = {
        {"he doesn't", "understand", "how lucky he was"},
    }
}
