...
const translations = {
    en: {
        ...
        faq_a3: 'Any modern Roblox executor works — Synapse X, KRNL, Fluxus, Solara. Just paste the loadstring and execute.',
    ...
    ru: {
        ...
        faq_a1: 'Да. Все продукты Hexagon полностью бесплатны. Решётка принадлежит всем.',
        ...
        faq_a3: 'Подойдёт любой современный executor — Synapse X, KRNL, Fluxus, Solara. Просто вставь loadstring и выполни.',
